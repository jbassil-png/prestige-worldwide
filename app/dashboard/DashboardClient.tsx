...
export default function DashboardClient({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Top bar */}
      <header className="bg-white border-b border-gray-100 px-3 sm:px-6 py-3 flex items-center gap-2 sm:gap-4">
        <span className="font-bold text-brand-700 text-sm sm:text-base md:text-lg">Prestige Worldwide</span>
      ...
      {/* Main layout */}
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6 grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        {/* Left column */}
