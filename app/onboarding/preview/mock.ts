...
export const MOCK_ACCOUNTS: Account[] = [
  { name: "401(k) (United States)", type: "401(k)", balanceUsd: 124000, currency: "USD", countryCode: "US", source: "manual" },
  { name: "IRA / Roth IRA (United States)", type: "IRA / Roth IRA", balanceUsd: 38000, currency: "USD", countryCode: "US", source: "manual" },
  { name: "RRSP (Canada)", type: "RRSP", balanceUsd: 67000, currency: "CAD", countryCode: "CA", source: "manual" },
  { name: "TFSA (Canada)", type: "TFSA", balanceUsd: 31000, currency: "CAD", countryCode: "CA", source: "manual" },
];
